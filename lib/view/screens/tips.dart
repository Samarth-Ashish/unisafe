...
class TipsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(centerTitle: true, backgroundColor: Colors.deepOrange.withValues(alpha: 0.7), title: const Text('Reporting Tips')),
      body: ListView(
        ...
        children: [
          ...
          _buildTip('Report Immediately', 'Report bullying incidents promptly to prevent escalation while still maintaining anonymity.'),
          _buildTip(
            'No Retaliation',
