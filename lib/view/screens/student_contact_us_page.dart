...
class StudentContactUsPage extends StatefulWidget {
  const StudentContactUsPage({super.key});

  @override
  State<StudentContactUsPage> createState() => _StudentContactUsPageState();
}

class _StudentContactUsPageState extends State<StudentContactUsPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.orange.withValues(alpha: 0.7), centerTitle: true, title: const Text('Contact Us')),
      body: Padding(
